...
Group: System/tools
Autoreq: no
Requires: python >= 2.7, python-netaddr >= 0.7.5, python-jwt >= 1.0.1, python-requests >= 2.6.0, python-routes >= 2.3.1, python-webob >= 1.2.3, python-jsonschema >= 2.3.0, python-six >= 1.9.0, zthin >= 3.1.0
